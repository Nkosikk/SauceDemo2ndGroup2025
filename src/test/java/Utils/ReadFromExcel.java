...
public class ReadFromExcel {
    ...
    public static String lastname=UserInformation.getRow(1).getCell(1).getStringCellValue();
    public static String postalcode=UserInformation.getRow(1).getCell(2).getStringCellValue();
